    ...
    return (
        ...
        >
                    ...
                    <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardTitle className="text-lg">
                                    Periodiek onderhoud in Excel of iemands
                                    hoofd
                                </CardTitle>
                            </CardHeader>
                            <CardContent>
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardTitle className="text-lg">
                                    Geen overzicht welke machines meeste
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <p className="text-sm text-muted-foreground">
                                    Zonder data is het lastig om investeringen
                                    in nieuwe machines te onderbouwen.
                                </p>
                            </CardContent>
                        </Card>
                    </div>
            ...
            <section className="bg-muted/50 py-20">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <h2 className="mb-4 text-center text-3xl font-bold">
                        Start met een kleine pilot, niet met een groot
                        IT-project
                    </h2>
                    <p className="mx-auto mb-12 max-w-2xl text-center text-lg text-muted-foreground">
                    ...
                    <div className="grid gap-8 md:grid-cols-3">
                        <div className="text-center">
                            ...
                            <p className="text-sm text-muted-foreground">
                                Operator appt een storing, maar na 100 berichten
                                is het weer zoeken welke machine het was.
                            </p>
                            <Card>
                                <CardHeader>
                                    <FileSpreadsheet className="mb-2 h-8 w-8 text-destructive" />
                                ...
                                <CardContent>
                                    <p className="text-sm text-muted-foreground">
                                        Wanneer moet die machine weer gesmeerd?
                                        Die vraag leeft alleen in het hoofd van
                                        je TD.
                                    </p>
                                </CardContent>
                            </Card>
                            <Card>
                                ...
                                <CardContent>
                                    <p className="text-sm text-muted-foreground">
                                        Je weet dat machine 3 vaak uitvalt, maar
                                        hoe vaak precies? En wat kost dat?
                                    </p>
                                </CardContent>
                            </Card>
                            <Card>
                                ...
                                <CardContent>
                                    <p className="text-sm text-muted-foreground">
                                        Zonder data is het lastig om
                                        investeringen in nieuwe machines te
                                        onderbouwen.
                                    </p>
                                </CardContent>
                            </Card>
                        ...
                        <div className="mt-12 text-center">
                            <p className="text-lg text-muted-foreground">
                                Als hoofd TD ben je constant brandjes aan het
                                blussen. Er is geen tijd om alles netjes bij te
                                houden, maar dat gebrek aan overzicht maakt je
                                werk alleen maar drukker.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid gap-8 md:grid-cols-3">
                        <div className="text-center">
                            ...
                            <p className="text-sm text-muted-foreground">
                                Importeer je machines, voeg gebruikers toe, en
                                je bent klaar. Geen maanden wachten.
                            </p>
                        </div>
                        <div className="text-center">
                            <div className="mb-4 flex justify-center">
                            ...
                            <p className="text-sm text-muted-foreground">
                                Simpele training zodat iedereen meteen aan de
                                slag kan. Geen dikke handleidingen.
                            </p>
                        </div>
                        <div className="text-center">
                            <div className="mb-4 flex justify-center">
                            ...
                            <p className="text-sm text-muted-foreground">
                                ...
                                Persoonlijke begeleiding, geen grote
                                consultancy.
                            </p>
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <AccordionItem value="item-3">
                            ...
                            <AccordionContent>
                                ...
                                technici kunnen werkorders bekijken en updaten
                                op hun telefoon.
                            </AccordionContent>
                        </AccordionItem>
                        <AccordionItem value="item-4">
                            ...
                            <AccordionContent>
                                Absoluut. Je kunt een CSV-bestand uploaden met
